...
public class TC05_Verifapplyjob extends TestBase {

	public static final Logger log = Logger.getLogger(TC05_Verifapplyjob.class.getName());
	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC05_Verifapplyjob");
	...
	public void Signin() throws IOException, InterruptedException, AWTException {
		...
		log.info("<=========== Started Verifying Apply job ===========> ");
		openAppUrl();
