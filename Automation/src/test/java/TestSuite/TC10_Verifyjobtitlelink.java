...
public class TC10_Verifyjobtitlelink extends TestBase{
	public static final Logger log = Logger.getLogger(TC10_Verifyjobtitlelink.class.getName());
	//@BeforeClass
	//public static void startTest() {

	//	test = extent.startTest("TC10_Verifyjobtitlelink ");
