...
public class TC14_Verifyprofileview extends TestBase {

	public static final Logger log = Logger.getLogger(TC14_Verifyprofileview.class.getName());
	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC14_Verifyprofileview");
