...
public class TC13_Verifyaccountdeletefunctionality extends TestBase {

	public static final Logger log = Logger.getLogger(TC13_Verifyaccountdeletefunctionality.class.getName());
	//@BeforeClass
	//public static void startTest() {

		//test = extent.startTest("TC13_Verifyaccountdeletefunctionality");
	...
	public void Signin() throws IOException, InterruptedException, AWTException {
		...
		log.info("<=========== Started Verifying account delete ===========> ");
		openAppUrl();
